...
const Index = () => {
    ...
    return (
        <div className="wrapper">
            ...
            <header>
                <img className="logo" src="../../public/icon/logo-white.svg" alt=""/>
            </header>
            <main>
                <a className="link" href="https://www.facebook.com/fbcameraeffects/testit/312994871640656/MzYxMmYxOGVkNzA3NzZkYzg5Njc3Y2NiMDVmZWNlNjQ=/?source=test_link" target="_blank" rel="noopener noreferrer">
                    <img className="main-image" src="../../public/img/pedro-navaja.webp" alt="portada del filtro de pedro Navaja"/>
                    <div className="link-background">
                        <img className="manita" src="../../public/icon/Manita.svg" alt=""/>
                    </div>
                </a>
                <p className="texto">
