...
const MyBook = (props) => {
    ...
    useEffect(() => {
        setTimeout(() => {
            ...
            // console.log(book.current.pageFlip().pages.app.ui.onTouchMove = () => {})
            // console.log(book.current.pageFlip().pages.app.ui.onTouchEnd = () => {})
            // book.current.pageFlip().pages.app.setting.useMouseEvents = false
            // book.current.pageFlip().pages.app.setting.swipeDistance = 100
            if (window) {
                (function(a){
